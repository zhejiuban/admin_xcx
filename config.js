...
var config = {
  ...
  //管理员获取openID和unionID
  adminLoginUrl: `${host}/admin_login`,

  //单位管理员系统认证
  adminAuthUrl: `${host}/admin_auth`,

  //单位管理员系统认证
  adminIndexUrl: `${host}/admin/index`,

  //单位管理员系统认证
  adminRepairListUrl: `${host}/admin/repair_list`,

  //获取该单位所关联的所有服务商以及擅长维修项目和维修资产类别接口
  serviceProviderListUrl: `${host}/admin/service_provider_list`,

  //获取指定条件下的维修人员接口
  workerListUrl: `${host}/admin/worker_list`,

  //管理员把工单分派给指定维修人员接口
  assignWorkerUrl: `${host}/admin/assign_worker`,

  //管理员把工单分派给指定维修人员接口
  deleteRepairUrl: `${host}/admin/delete_repair`,
